...
const ContactForm = () => {
    ...
    return (
        ...
        <div class="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-black  border-[1px] border-[#00CCDD]  rounded-lg">
            <div class="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                <div>
                    ...
                    <ul class="flex mt-12 space-x-4">
                        <li class="bg-[#00CCDD] hover:bg-[#a91079e2] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                ...
                <div class="bg-gray-100 p-6 rounded-lg">
                    ...
                    <div class="space-y-4 max-lg:mt-4">
                        <button type="button" class="  hover:bg-purple-600 px-4 py-2 rounded-lg   text-gray-800 text-sm tracking-wider font-medium outline-none border-2 border-gray-300  mr-4 btn ">Premium</button>
                        <button type="button" class="  hover:bg-purple-600 px-4 py-2 rounded-lg bg-transparent text-gray-800 text-sm tracking-wider font-medium outline-none border-2 border-gray-300 mr-4 btn ">General</button>
                        <button type="button" class="  hover:bg-purple-600 px-4 py-2 rounded-lg bg-transparent text-gray-800 text-sm tracking-wider font-medium outline-none border-2 border-gray-300  btn    ">Series</button>
                    </div>

                    <form  onSubmit={onSubmit} class="mt-8 space-y-4">
                        <input type='text' placeholder='Name' name="name"
                            class="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#a91079]" required />
                        <input type='email' placeholder='Email' name="email"
                            class="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#a91079]" required />
                        <input type='text' placeholder='Subject' name="subject"
                            class="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#a91079]" required />
                        <textarea placeholder='Message'  required rows="6" name="message"
                            class="w-full rounded-lg px-4 text-gray-800 text-sm pt-3 outline-[#a91079]"></textarea>
                       
                        <button  className="text-white btn bg-[#00CCDD] hover:bg-[#a91079e2] tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6  font-mono "  >Send  <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill='#fff' class="mr-2" viewBox="0 0 548.244 548.244">
